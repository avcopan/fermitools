...
ACO = numpy.load(os.path.join(data_path, 'ocepa0/aco.npy'))
ACV = numpy.load(os.path.join(data_path, 'ocepa0/acv.npy'))
BCO = numpy.load(os.path.join(data_path, 'ocepa0/bco.npy'))
BCV = numpy.load(os.path.join(data_path, 'ocepa0/bcv.npy'))
...
def test__solve():
    ...
    en_elec, (aco, bco), (acv, bcv), t2, info = ocepa0.solve(

...
def main():
    ...
    en_dx2 = fermitools.math.central_difference(en_orb, t1, step=0.05, nder=2,
                                                npts=9)
    en_dt2 = fermitools.math.central_difference(en_amp, t2_flat, step=0.05,
                                                nder=2, npts=9)

    print("Numerical orbital Hessian diagonal:")
    print(numpy.ravel(en_dx2))

    print("A_orb + B_orb diagonal:")
    print(numpy.diag(a_orb + b_orb).round(9))

    print("Ratio:")
    print(numpy.diag(a_orb + b_orb) / numpy.ravel(en_dx2))

    print("Numerical amplitude Hessian diagonal:")
    print(numpy.ravel(en_dt2))

    print("A_amp + B_amp diagonal:")
